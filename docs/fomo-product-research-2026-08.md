...
| 收入构成（8/08 周） | Solana **$2.6M** + Hyperliquid perps builder fee **$38.8K** | 即 **98.5% 收入来自 Solana 现货** |
...
- **98.5% 收入来自 Solana 现货**（8/08 周），perps 只贡献 $38.8K —— **perps 目前是叙事而非收入**。
...
| 2 | 各链交易量拆分 | 98.5% 收入来自 Solana → Base/BNB/Monad/RH 是不是"叙事链"？ | 各链收费地址链上统计 |
