...
| 层 | 文档 | 回答什么 | 什么时候看 |
|---|---|---|---|
| **Tier 0** | [FOMO 决策简报](fomo-brief.html) | 结论 · 威胁分级 · P0/P1 | 转发给决策层，一屏读完 |
| **Tier 1** | [FOMO 增长闭环](fomo-growth-loop.html) | **病在哪** —— 飞轮机制、铰链、漏损点、获客导图 | 想理解它为什么转得快 |
...
> **📐 分层说明**：增长机制的**论证**（飞轮如何闭合、铰链在哪、四条加速支路、影响力发生器）已移入 **[《FOMO 增长闭环》](fomo-growth-loop.html)** —— 那份文档回答「病在哪」。
...
**关键统计**：X 粉丝跨度 **10.7×**（752 → 8,073），FOMO 粉丝跨度仅 **2.8×**（8,248 → 23,035）。⚠️ **存在选择偏差**：官方只会点名倍数高的样本，n=5，不代表平台平均水平。机制解读见[增长闭环 §04](fomo-growth-loop.html)。
...
> **📐 这是唯一的行动清单。**[《FOMO 增长闭环》](fomo-growth-loop.html) 只做诊断（按闭环环节看我们的位置），不重复列行动——避免两处优先级打架。
> 需要一页纸转发给决策层的版本见 **[《FOMO 决策简报》](fomo-brief.html)**。
