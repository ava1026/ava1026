...
<section id="s5">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td><strong>Apple Pay 直接购买 meme 代币</strong></td><td><span class="pill p-us">已支持</span></td><td>与 FOMO 的王牌入金通道同级——而它的 Apple Pay 疑似已失效（见 §09 待核 ①）</td></tr>
...
<section id="s9">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td><strong>我们法币入金的链覆盖</strong></td><td>已确认：50+ 国家、Apple Pay 直购 meme 代币（Ava 08-13）。剩一问：<strong>覆盖哪些链</strong>——它决定「新链天然优势」能不能对外讲，也决定主报告 §9「入金门槛 ❌ FOMO 明显领先」那行怎么改</td></tr>
