...
<section id="s0">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td><strong>给谁用</strong></td><td>圈外小白 · 链上新用户 · 打二段用户——第一屏＝热门列表，第一笔交易</td></tr>
      <tr><td><strong>前置地基</strong></td><td>Relay 交易解析（GMGN-8687 / 8688 / 8689 / 8665）＋ relay 数据的标注与可信度规范</td></tr>
    </tbody>
  </table>
  </div>
</section>
