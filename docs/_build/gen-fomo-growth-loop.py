...
<section>
  ...
  <h2>五条并行通道</h2>
  <p>把「获客」这个词展开，FOMO 实际同时在跑五条通道。按当前的权重排序：<strong>社交裂变</strong>提到最前，因为原生红人孵化就长在这一条上，它同时供给内容、跟单对象和下一批红人。而<strong>产品即获客</strong>是最容易被漏看、也最难被复制的一条。</p>
  __FIG3__
  <div class="note">
...
out = HTML.replace("__FIG1__",
        ...
        '<figure>' + fig3() + '<figcaption><b>图 3 · 获客侧思维导图。</b>五条并行通道及其具体手段，<b>★ 为本轮 X 数据新增</b>。「社交裂变」置于最前，因为原生红人孵化就长在这一条上；而「产品即获客」是唯一一次性建设、永久生效的通道——也是最难追平的一条。</figcaption></figure>'
    ).replace("__FIG4__",
